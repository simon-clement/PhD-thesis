...
if the surface layer. We first compare 3 state-of-the-art
...
\subsubsection{State-of-the art strategies}
  ...
  \begin{itemize}
    \item "FV pure": Similar to what is done in Finite Differences.
    \item "FV1": Similar to what is done with Finite Volumes.
    \item "FV2": Rewriting the results of {\color{red}Nishizawa}
  \end{itemize}
