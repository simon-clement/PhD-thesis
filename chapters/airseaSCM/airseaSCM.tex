...
\begin{equation}
	K_u = C_m l_m \sqrt{e}, ~~~~~~~ K_\theta = \frac{C_m}{\rm Pr}
	l_m \sqrt{e}
\end{equation}
...
\begin{equation}
\begin{aligned}
	K_u &\propto (z+z_u)~ \phi_m\left(\frac{z}{L_{MO}}\right) \\
	K_\theta &\propto (z+z_u)~ \phi_h\left(\frac{z}{L_{MO}}\right)
\end{aligned}
\end{equation}
...
orientation of $u$ will be noted $e_\tau = \frac{u}{|u|}$.
\begin{figure}
	\centering
