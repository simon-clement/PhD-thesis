...
\myTD{recap du système couplé, neutre ou pas}
...
\myTD{plus de détails sur la reformulation}
\myTD{système complet là dessus}
...
case where both viscosities are constant and
the law of the wall is not applied at the interface.
\myTD{système complet}
