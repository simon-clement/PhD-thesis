...
\myTD{In Section [..] we will give some elements to prove the well-posedness
of the nonstationary case.}
%
%
%
...
\begin{figure}
    \centering
    \includegraphics[scale=0.65]{shannon_pedago.pdf}
	\caption{Singular value $\widetilde{\xi}_1(\omega)$.
	The set of discrete frequencies do not contain
	with our parameters the peaks around $\{f, -f\}$.
	}
    \label{fig:OASchwarz_shannonPedago}
\end{figure}
...
$\{\frac{\pi l}{T},
l \in [-\frac{T}{\Delta t},\frac{T}{\Delta t}]\cap \mathbb{N}\}$
...
The difference between the continuous and discrete frequencies
is illustrated in Figure \ref{fig:OASchwarz_shannonPedago}.
\myTD{figure 6.6 mais avec $f\approx 2e-4$}
