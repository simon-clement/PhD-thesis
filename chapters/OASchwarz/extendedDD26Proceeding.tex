...
\end{aligned}
\end{equation}
When $\omega+f \rightarrow 0$
the biggest eigenvalue of the matrix
\eqref{eq:OASchwarz_transitionMatrixDD26}
should be identical to the asymptotic case
and the other ones should vanish. (?)
{\color{red} TODO y réfléchir et valider numériquement}
