...
\section{Discrete stationary state and well-posedness}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.65]{plotEigenvalues.pdf}
...
\end{figure}
The singular values (shown in Figures \ref{fig:OASchwarz_singularValues} and \ref{fig:OASchwarz_nonasymptotic})
...
the singular values are different for small frequencies, especially
around the frequencies $f$ and $-f$.
...
\begin{figure}
	...
	\caption{The vector $\begin{pmatrix} B_k \\ 0 \end{pmatrix}$ can be decomposed
	into a basis of eigenvector which converge linearly with
	convergence factors $\widetilde{\xi}_1, \widetilde{\xi}_2$.
	4 iterations are presented in red, blue, green and purple.
	The
