...
\myTD{refaire un passage pour la rendre plus facile à lire et
les calculs plus faciles à suivre.}
...
$\sigma > 0$.
Let us note 
\myTD{Pas super clair je trouve, pour définir $S^1_m$ et $S^2_m$. 
- j'inverserais l'égalité : B := S + C
- je préciserais ce que tu as en tête : $C_3$ et $C_4$
représentent tout ce qui est indépendant de m, c'est ça ?}
$\begin{pmatrix}
	S_m^1(U_0) + {C}_3\\
	S_m^2(U_0) + {C}_4
