...
{\color{red} TODO utiliser
la version simple et voir si ça fonctionne: pourquoi on utilise
la version compliquée dans le code ?!}
...
\eqref{eq:ND_StratifiedCase_solution_l_down1} to compute $l_{down}$.
