...
\paragraph{Mixing lengths} \myTD{expliciter les dépendances en z}
...
\end{equation}
\myTD{Introduire $C_m, C_s, C_e, \phi_z$ ($\phi_z$ peut être def
comme l'inverse du nombre de Prantl turbulent)}
\myTD{Référence $l_m, l_\epsilon$ pour se dédouanner
bougeault et andré}
