...
{\color{red} A rédiger mieux: montrer que
$\partial_{\delta_{sl}}(K_0\phi_0)(z_\frac{1}{2})=0$ au moins
pour $z_0M$ fixé. Pour $z_0M$ non fixé ça doit pouvoir se faire
aussi je pense. Ca veut dire qu'il est inutile d'essayer de faire
mieux en différences finies puisque y'a pas une grosse sensibilité.
Ca va donc nécessairement (pour pas perdre la face) avec
une démonstration de l'importance de FV free ?}
\par
