...
rather than the "relative" w.r.t. the surface currents. In
the neutral case we assume $u(0,t)=0$ to shorten the expressions.
%
\begin{figure}
	\centering
...
$z_{u} = z_u({K_{u, {\rm mol}}}, u_\star)$ depends on the
...
\S \ref{sec:ND_NeutralCase_continuousModel}
