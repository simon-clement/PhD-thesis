...
\includepdf[pages=1,pagecommand={}]{paperApproximatedDiscreteSchwarz.pdf}
\invisiblesection{Discretisation and Schwarz methods studied}
\includepdf[pages=2-3,pagecommand={}]{paperApproximatedDiscreteSchwarz.pdf}
...
\includepdf[pages=4-5,pagecommand={}]{paperApproximatedDiscreteSchwarz.pdf}
\invisiblesubsection{Frequency range of validity for the modified equation technique}
\includepdf[pages=6,pagecommand={}]{paperApproximatedDiscreteSchwarz.pdf}
\invisiblesection{Combining semi-discrete analyses}
\includepdf[pages=7-8,pagecommand={}]{paperApproximatedDiscreteSchwarz.pdf}
\invisiblesection{Effect on the optimisation on free parameters}
\invisiblesubsection{One-parameter optimisation}
\includepdf[pages=9-10,pagecommand={}]{paperApproximatedDiscreteSchwarz.pdf}
\invisiblesubsection{Robin two-sided optimisation}
\invisiblesubsection{Robustness}
\includepdf[pages=11-,pagecommand={}]{paperApproximatedDiscreteSchwarz.pdf}
